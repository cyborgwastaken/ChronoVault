...
import { Lock, Clock, GlobeLock, ArrowRight, Fingerprint } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    desc: 'Uses a pre-trained Siamese face embedding from webcam enrollment, validated with PIN and hash integrity before retrieval.',
    color: 'text-cyan-400',
    bg: 'bg-cyan-500/8',
  },
];
