...
export default function Upload() {
    ...
    const handleUpload = async () => {
        ...
        // --- NEW: Security Check ---
        if (!session) {
            alert("Access Denied: Please sign in with Google to secure files.");
            return;
        }
        ...
        try {
            ...
            // Force a page reload to instantly update the Navbar credit balance
            ...
            {!artifactData ? (
                        ...
                        <div style={{ width: '100%' }}>
                            ...
                            >
                                ...
                                <p style={{ margin: 0, marginTop: '0.5rem', color: file ? 'var(--success)' : 'var(--text-muted)' }}>
                                    {file ? `${(file.size/1024).toFixed(2)} KB Ready for Encryption` : "Cost: ₹40 Credits"}
                                </p>
                            </div>
                        </div>
                ...
                <div className="grid-container">
                    <div className="glass-panel" style={{ gridColumn: 'span 12', padding: '2rem', background: 'rgba(50, 215, 75, 0.05)' }}>
                        ...
                        <p style={{ color: 'var(--success)', fontWeight: 'bold' }}>✓ ₹40 Credits Deducted. Artifacts generated.</p>
                    </div>
