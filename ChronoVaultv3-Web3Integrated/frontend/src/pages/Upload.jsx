...
export default function Upload() {
    ...
    const [txStatus, setTxStatus] = useState(""); // NEW: Tracks blockchain status
            ...
            if (window.ethereum) {
                ...
                try {
                    await window.ethereum.request({
                        ...
                        params: [{ chainId: '0xaa36a7' }], // 0xaa36a7 is the hex code for Sepolia
                    });
                } catch (switchError) {
                ...
                await tx.wait(); // Pauses until the blockchain network confirms the transaction
            ...
            {!artifactData ? (
                ...
                <div className="grid-container">
                    <div className="glass-panel" style={{ gridColumn: 'span 12', padding: '2rem', background: 'rgba(50, 215, 75, 0.05)' }}>
                        ...
                        <p style={{ color: 'var(--success)', fontWeight: 'bold', marginTop: '0.5rem' }}>✓ Secured to Blockchain</p>
                    </div>
